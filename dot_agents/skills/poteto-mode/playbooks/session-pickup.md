...
1. Locate the prior trail using pstack-runtime's scoped history reference, an explicitly supplied session URL, the task ledger, or a pushed branch. Read metadata and recent messages before older decision points. Delegate long transcript analysis only within the identified workspace.
