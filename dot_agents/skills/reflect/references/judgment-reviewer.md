...
- Dedicated Read calls or shell reads against any `SKILL.md` file (workspace `.agents/skills/`, user-level `~/.agents/skills/`, or plugin-installed paths under `the host's plugin cache`)
