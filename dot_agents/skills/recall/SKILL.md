...
Locate transcripts using pstack-runtime's scoped history reference. Confirm workspace and session metadata before reading message bodies; inspect the host's actual event format.
