...
Before handing back, compare the trail with tool results and the scoped session transcript found through pstack-runtime. If no transcript is available, mark transcript-only claims unverified. Walk the log against what actually happened:
